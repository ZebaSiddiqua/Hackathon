...
function requestUserRepos(username){
    ...
    xhr.onload = function () {
        ...
        for (let i in data) {
            ...
            li.setAttribute("style"," background: linear-gradient(to bottom right, #ccffff 0%, #ffffff 57%)");
...
const url = "https://api.github.com/repos/" + username  + "/" + respname + "/contents";
    ...
    xhr.onload = function () {
		...
		li2.setAttribute("style"," background: linear-gradient(to bottom left, #ccffff 0%, #ffffff 57%)");
